      ...
      <section>
        <div className='px-8 py-12'>
          <div className='flex flex-col md:flex-row'>
            <div className='w-full md:w-[60%] h-auto md:h-[580px] border border-black bg-[#2A254B] text-white px-4 md:px-12 py-6 md:py-12 flex flex-col justify-between shadow-lg'>
              <div>
                <h1 className='text-xl md:text-3xl md:text-left mt-0'>
                  The furniture brand for the future with <br /> the timeless designs
                </h1>
                <div className='flex justify-center md:justify-start mt-4'>
                  <button className='w-[170px] h-[56px] bg-transparent text-white border border-gray-600 font-bold hover:bg-gray-600 hover:text-white transition duration-300'>
                    View collection
                  </button>
                </div>
              </div>
