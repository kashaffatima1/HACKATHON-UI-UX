...
export default async function CutleryCategoryPage() {
  // Query to fetch only products in the "Cutlery" category
  const query = `
  ...
  return (
    <div className="px-4 mt-0 md:px-8 py-12 text-[#2A254B] font-[Clash Display]">
      <h1 className="text-2xl font-semibold mb-8">Cutlery</h1>
