...
export default async function PlantPotsCategoryPage() {
  // Query to fetch only products in the "Plant Pots" category
  const query = `
  ...
  return (
    <div className="px-4 mt-0 md:px-8 py-12 text-[#2A254B] font-[Clash Display]">
      <h1 className="text-2xl font-semibold mb-8">Plant Pots</h1>
