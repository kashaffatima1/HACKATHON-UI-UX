...
export default async function CeramicsCategoryPage() {
  // Query to fetch only products in the "Ceramics" category
  const query = `
  ...
  return (
    <div className="px-4 mt-0 md:px-8 py-12 text-[#2A254B] font-[Clash Display]">
      <h1 className="text-2xl font-semibold mb-8">Ceramics</h1>
